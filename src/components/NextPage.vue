<template>
  <div class="flex flex-col items-start justify-center gap-2" data-aos="fade-left">
  ...
  <!-- tech stacks  -->
  <div data-aos="fade-up" class="mt-20 flex flex-col justify-center items-center">
    <div class="text-black text-4xl font-bold">🧰 My Tech Stacks and Tools are listed as of below...... </div>
    <!-- img  -->
    <div
      class="text-white p-8 mt-5 w-full h-[1300px] md:h-[1300px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-1 xl:grid-cols-2 gap-4 justify-items-center"
      ...
      <div
        ...
        <svg class="w-14 h-14" fill="none" height="24" viewBox="0 0 24 24" width="24"
      ...
      <div
        ...
        <svg class="w-14 h-14" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100"
          ...
          <path fill="#ffc107"
            d="M24,4v20l8,4l-8.843,16c0.317,0,0.526,0,0.843,0c11.053,0,20-8.947,20-20S35.053,4,24,4z"></path>
          <path fill="#4caf50" d="M44,24c0,11.044-8.956,20-20,20S4,35.044,4,24S12.956,4,24,4S44,12.956,44,24z"></path>
          <path fill="#ffc107"
            d="M24,4v20l8,4l-8.843,16c0.317,0,0.526,0,0.843,0c11.053,0,20-8.947,20-20S35.053,4,24,4z"></path>
          <path fill="#f44336"
  ...
  <div data-aos="fade-down" class="mt-32 flex flex-col justify-center items-center">
    ...
    <div
      ...
      <div class="border-1 border-gray-200 w-auto h-auto p-4 rounded-xl flex flex-col justify-center items-start gap-4">
        ...
        <h1 class="text-gray-600 text-sm">Devcent is a hands-on tech training platform focused on transforming beginners
          ...
          in-demand skills like frontend, backend, and full-stack development.</h1>
        <a href="https://devcent-nine.vercel.app/" target="_blank" rel="noopener noreferrer"
      ...
      <div class="border-1 border-gray-200 w-auto h-auto p-4 rounded-xl flex flex-col justify-center items-start gap-4">
        ...
        <h1 class="text-gray-600 text-sm">This is a sleek, real-time weather app that fetches live weather data using an
          ...
          to deliver accurate and dynamic forecasts.
    ...
    <div class="flex flex-col items-center gap-5 text-sm text-gray-600 mt-32 p-2">
      <div class="fixed left-0 right-0 h-1 bg-gray-200 my-6 rounded"></div>
      <span>🤝</span>
      <span>Copyright © 2025 Taofeeq Ifedolapo.</span>
    </div>
...
const handleSubmit = async () => {
  ...
  try {
    const res = await fetch('https://formspree.io/f/xgvzwoze', {
      method: 'POST',
